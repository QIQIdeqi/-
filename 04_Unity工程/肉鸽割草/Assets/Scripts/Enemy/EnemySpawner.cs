...
namespace GeometryWarrior
{
    ...
    public class EnemySpawner : MonoBehaviour
    {
        ...
        private void Start()
        {
            ...
            // if (player == null)
            // {
            //     Debug.LogError("EnemySpawner: 找不到 Player！");
            // }
            // else
            // {
            //     Debug.Log("EnemySpawner: 已找到 Player");
            // }
            
            // if (enemyPrefab == null)
            // {
            //     Debug.LogError("EnemySpawner: Enemy Prefab 未设置！");
            // }
            // else
            // {
            //     Debug.Log($"EnemySpawner: 敌人预制体已设置 - {enemyPrefab.name}");
            // }
        }
