...
- `BackpackContentSetupTool` - 设置主角装备页
...
- `BackpackPanel` - 背包主界面 - 整合主角装扮和家园布置两个页签
...
- `BackpackContentSetupTool` - 设置主角装备页
- `BackpackPanelFixer` - BackpackPanel 层级修复工具 - 修复页签点击问题
...
- `OutfitPanelNewRebuilder` - 
- `OutfitPanelNewRefFixer` - OutfitPanelNew 引用配置工具
- `OutfitPanelNewRefSetupToolV2` - 创建 CategoryTab 预制体
- `OutfitPartCreator` - 装扮部件创建工具
- `PlayerEquipPageSetupTool` - 主角装扮页面设置工具 - 修复重叠问题
...
- `HomeDecorationPage` - 家园布置页面 - 显示家具/装饰品列表
- `HomeHUD` - 家园场景HUD - 显示摇杆、背包按钮、提示信息等
- `HomeOutfitPageContent` - 初始化布置面板
...
- `OutfitPanelNew` - 
- `PlayerEquipPage` - 主角装扮页面 - 显示当前装备的外观部件
...
### BackpackContentSetupTool
- **文件**: `Assets\Scripts\Editor\BackpackContentSetupTool.cs`
...
- **描述**: 背包主界面 - 整合主角装扮和家园布置两个页签
- **单例**: 是
- **MonoBehaviour**: 是
- **公共方法**: Initialize, Show, Show, Hide, Reopen
- **被引用**: BackpackContentSetupTool, BackpackPanelFixer, BackpackPanelLayoutFixer, BackpackSystemSetupWizard, BackpackTabRenameTool...

### BackpackPanelFixer
- **文件**: `Assets\Scripts\Editor\BackpackPanelFixer.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: BackpackPanel 层级修复工具 - 修复页签点击问题
- **单例**: 否
- **MonoBehaviour**: 否
...
### BackpackTabRenameTool
- **文件**: `Assets\Scripts\Editor\BackpackTabRenameTool.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: 
- **单例**: 否
- **MonoBehaviour**: 否
...
### FontLoader
- **文件**: `Assets\Scripts\Utils\FontLoader.cs`
- **命名空间**: GeometryWarrior
- **描述**: 字体加载工具 - 统一加载项目中文字体
- **单例**: 否
- **MonoBehaviour**: 否
- **被引用**: HomeOutfitPageContent
...
- **被引用**: HomeSceneSetupTool, HomeManager, HomeDecorationPage, HomeOutfitPageContent

### HomeDecorationPage
- **文件**: `Assets\Scripts\UI\HomeDecorationPage.cs`
- **命名空间**: GeometryWarrior
- **描述**: 家园布置页面 - 显示家具/装饰品列表
- **单例**: 否
- **MonoBehaviour**: 是
- **公共方法**: RefreshDisplay
- **被引用**: HomeOutfitPageContent
...
### HomeOutfitPageContent
- **文件**: `Assets\Scripts\UI\HomeOutfitPageContent.cs`
- **命名空间**: GeometryWarrior
- **描述**: 初始化布置面板
- **单例**: 否
- **MonoBehaviour**: 是
- **被引用**: BackpackContentSetupTool
...
- **MonoBehaviour**: 是
- **公共方法**: Show, Hide
- **被引用**: BackpackContentSetupTool, BackpackPanelLayoutFixer, BackpackSystemSetupWizard, BackpackUIReferenceSetupTool, CodeAutoCleanupTool...
...
- **单例**: 否
- **MonoBehaviour**: 是
- **被引用**: BackpackContentSetupTool, BackpackSystemSetupWizard, CodeAutoCleanupTool, CodeIndexer, HomeSystemCleanupTool...

### OutfitPanelNewRebuilder
- **文件**: `Assets\Scripts\Editor\OutfitPanelNewRebuilder.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: 
- **单例**: 否
- **MonoBehaviour**: 否

### OutfitPanelNewRefFixer
- **文件**: `Assets\Scripts\Editor\OutfitPanelNewRefFixer.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: OutfitPanelNew 引用配置工具
- **单例**: 否
- **MonoBehaviour**: 否

### OutfitPanelNewRefSetupToolV2
- **文件**: `Assets\Scripts\Editor\OutfitPanelNewRefSetupToolV2.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: 创建 CategoryTab 预制体
- **单例**: 否
- **MonoBehaviour**: 否
...
### PlayerEquipPage
- **文件**: `Assets\Scripts\UI\PlayerEquipPage.cs`
- **命名空间**: GeometryWarrior
- **描述**: 主角装扮页面 - 显示当前装备的外观部件
- **单例**: 否
- **MonoBehaviour**: 是
- **公共方法**: RefreshDisplay
- **被引用**: BackpackContentSetupTool, BackpackPanelFixer, PlayerEquipPageSetupTool, UIBuilderTool

### PlayerEquipPageSetupTool
- **文件**: `Assets\Scripts\Editor\PlayerEquipPageSetupTool.cs`
- **命名空间**: GeometryWarrior.Editor
- **描述**: 主角装扮页面设置工具 - 修复重叠问题
- **单例**: 否
- **MonoBehaviour**: 否
...
> **提示**: 命名空间 `GeometryWarrior` 包含 40 个类，建议拆分
> **提示**: 命名空间 `GeometryWarrior.Editor` 包含 19 个类，建议拆分
> **提示**: 以下 5 个脚本缺少描述注释：
> - BackpackTabRenameTool
> - HomeSystemCleanupTool
> - OutfitPanelNewRebuilder
